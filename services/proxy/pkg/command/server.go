...
import (
	...
	pkgmiddleware "github.com/owncloud/ocis/v7/ocis-pkg/middleware"
	...
	policiessvc "github.com/owncloud/ocis/v7/protogen/gen/ocis/services/policies/v0"
	...
	"github.com/owncloud/ocis/v7/services/proxy/pkg/config/parser"
	"github.com/owncloud/ocis/v7/services/proxy/pkg/logging"
	"github.com/owncloud/ocis/v7/services/proxy/pkg/metrics"
	"github.com/owncloud/ocis/v7/services/proxy/pkg/middleware"
	"github.com/owncloud/ocis/v7/services/proxy/pkg/proxy"
	"github.com/owncloud/ocis/v7/services/proxy/pkg/router"
	"github.com/owncloud/ocis/v7/services/proxy/pkg/server/debug"
	proxyHTTP "github.com/owncloud/ocis/v7/services/proxy/pkg/server/http"
	"github.com/owncloud/ocis/v7/services/proxy/pkg/staticroutes"
	"github.com/owncloud/ocis/v7/services/proxy/pkg/user/backend"
	"github.com/owncloud/ocis/v7/services/proxy/pkg/userroles"
