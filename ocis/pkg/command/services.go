...
import (
	...
	"github.com/owncloud/ocis/v7/ocis-pkg/config/parser"
	"github.com/owncloud/ocis/v7/ocis/pkg/command/helper"
	"github.com/owncloud/ocis/v7/ocis/pkg/register"
	activitylog "github.com/owncloud/ocis/v7/services/activitylog/pkg/command"
	antivirus "github.com/owncloud/ocis/v7/services/antivirus/pkg/command"
	appprovider "github.com/owncloud/ocis/v7/services/app-provider/pkg/command"
	appregistry "github.com/owncloud/ocis/v7/services/app-registry/pkg/command"
	audit "github.com/owncloud/ocis/v7/services/audit/pkg/command"
	authapp "github.com/owncloud/ocis/v7/services/auth-app/pkg/command"
	authbasic "github.com/owncloud/ocis/v7/services/auth-basic/pkg/command"
	authbearer "github.com/owncloud/ocis/v7/services/auth-bearer/pkg/command"
	authmachine "github.com/owncloud/ocis/v7/services/auth-machine/pkg/command"
	authservice "github.com/owncloud/ocis/v7/services/auth-service/pkg/command"
	clientlog "github.com/owncloud/ocis/v7/services/clientlog/pkg/command"
	collaboration "github.com/owncloud/ocis/v7/services/collaboration/pkg/command"
	eventhistory "github.com/owncloud/ocis/v7/services/eventhistory/pkg/command"
	frontend "github.com/owncloud/ocis/v7/services/frontend/pkg/command"
	gateway "github.com/owncloud/ocis/v7/services/gateway/pkg/command"
	graph "github.com/owncloud/ocis/v7/services/graph/pkg/command"
	groups "github.com/owncloud/ocis/v7/services/groups/pkg/command"
	idm "github.com/owncloud/ocis/v7/services/idm/pkg/command"
	idp "github.com/owncloud/ocis/v7/services/idp/pkg/command"
	invitations "github.com/owncloud/ocis/v7/services/invitations/pkg/command"
	nats "github.com/owncloud/ocis/v7/services/nats/pkg/command"
	notifications "github.com/owncloud/ocis/v7/services/notifications/pkg/command"
	ocdav "github.com/owncloud/ocis/v7/services/ocdav/pkg/command"
	ocm "github.com/owncloud/ocis/v7/services/ocm/pkg/command"
	ocs "github.com/owncloud/ocis/v7/services/ocs/pkg/command"
	policies "github.com/owncloud/ocis/v7/services/policies/pkg/command"
	postprocessing "github.com/owncloud/ocis/v7/services/postprocessing/pkg/command"
	proxy "github.com/owncloud/ocis/v7/services/proxy/pkg/command"
	search "github.com/owncloud/ocis/v7/services/search/pkg/command"
	settings "github.com/owncloud/ocis/v7/services/settings/pkg/command"
	sharing "github.com/owncloud/ocis/v7/services/sharing/pkg/command"
	sse "github.com/owncloud/ocis/v7/services/sse/pkg/command"
	storagepubliclink "github.com/owncloud/ocis/v7/services/storage-publiclink/pkg/command"
	storageshares "github.com/owncloud/ocis/v7/services/storage-shares/pkg/command"
	storagesystem "github.com/owncloud/ocis/v7/services/storage-system/pkg/command"
	storageusers "github.com/owncloud/ocis/v7/services/storage-users/pkg/command"
	thumbnails "github.com/owncloud/ocis/v7/services/thumbnails/pkg/command"
	userlog "github.com/owncloud/ocis/v7/services/userlog/pkg/command"
	users "github.com/owncloud/ocis/v7/services/users/pkg/command"
	web "github.com/owncloud/ocis/v7/services/web/pkg/command"
	webdav "github.com/owncloud/ocis/v7/services/webdav/pkg/command"
	webfinger "github.com/owncloud/ocis/v7/services/webfinger/pkg/command"
)
