...
import (
	...
	activitylog "github.com/owncloud/ocis/v7/services/activitylog/pkg/config"
	antivirus "github.com/owncloud/ocis/v7/services/antivirus/pkg/config"
	appProvider "github.com/owncloud/ocis/v7/services/app-provider/pkg/config"
	appRegistry "github.com/owncloud/ocis/v7/services/app-registry/pkg/config"
	audit "github.com/owncloud/ocis/v7/services/audit/pkg/config"
	authapp "github.com/owncloud/ocis/v7/services/auth-app/pkg/config"
	authbasic "github.com/owncloud/ocis/v7/services/auth-basic/pkg/config"
	authbearer "github.com/owncloud/ocis/v7/services/auth-bearer/pkg/config"
	authmachine "github.com/owncloud/ocis/v7/services/auth-machine/pkg/config"
	authservice "github.com/owncloud/ocis/v7/services/auth-service/pkg/config"
	clientlog "github.com/owncloud/ocis/v7/services/clientlog/pkg/config"
	collaboration "github.com/owncloud/ocis/v7/services/collaboration/pkg/config"
	eventhistory "github.com/owncloud/ocis/v7/services/eventhistory/pkg/config"
	frontend "github.com/owncloud/ocis/v7/services/frontend/pkg/config"
	gateway "github.com/owncloud/ocis/v7/services/gateway/pkg/config"
	graph "github.com/owncloud/ocis/v7/services/graph/pkg/config"
	groups "github.com/owncloud/ocis/v7/services/groups/pkg/config"
	idm "github.com/owncloud/ocis/v7/services/idm/pkg/config"
	idp "github.com/owncloud/ocis/v7/services/idp/pkg/config"
	invitations "github.com/owncloud/ocis/v7/services/invitations/pkg/config"
	nats "github.com/owncloud/ocis/v7/services/nats/pkg/config"
	notifications "github.com/owncloud/ocis/v7/services/notifications/pkg/config"
	ocdav "github.com/owncloud/ocis/v7/services/ocdav/pkg/config"
	ocm "github.com/owncloud/ocis/v7/services/ocm/pkg/config"
	ocs "github.com/owncloud/ocis/v7/services/ocs/pkg/config"
	policies "github.com/owncloud/ocis/v7/services/policies/pkg/config"
	postprocessing "github.com/owncloud/ocis/v7/services/postprocessing/pkg/config"
	proxy "github.com/owncloud/ocis/v7/services/proxy/pkg/config"
	search "github.com/owncloud/ocis/v7/services/search/pkg/config"
	settings "github.com/owncloud/ocis/v7/services/settings/pkg/config"
	sharing "github.com/owncloud/ocis/v7/services/sharing/pkg/config"
	sse "github.com/owncloud/ocis/v7/services/sse/pkg/config"
	storagepublic "github.com/owncloud/ocis/v7/services/storage-publiclink/pkg/config"
	storageshares "github.com/owncloud/ocis/v7/services/storage-shares/pkg/config"
	storagesystem "github.com/owncloud/ocis/v7/services/storage-system/pkg/config"
	storageusers "github.com/owncloud/ocis/v7/services/storage-users/pkg/config"
	thumbnails "github.com/owncloud/ocis/v7/services/thumbnails/pkg/config"
	userlog "github.com/owncloud/ocis/v7/services/userlog/pkg/config"
	users "github.com/owncloud/ocis/v7/services/users/pkg/config"
	web "github.com/owncloud/ocis/v7/services/web/pkg/config"
	webdav "github.com/owncloud/ocis/v7/services/webdav/pkg/config"
	webfinger "github.com/owncloud/ocis/v7/services/webfinger/pkg/config"
)
